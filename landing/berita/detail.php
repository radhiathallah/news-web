    <?php
    $slug = $_GET['slug'];
    $query = mysqli_query($koneksi, "SELECT * FROM tb_berita JOIN tb_kategori ON tb_berita.id_kategori=tb_kategori.id_kategori WHERE slug='$slug'");
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center bg-white border border-left-0" style="width: calc(100% - 180px); padding-right: 100px;">
                            ...
                            while ($data3 = mysqli_fetch_array($query3)) { ?>
                                <div class="text-truncate"><a class="text-secondary text-uppercase font-weight-semi-bold" href="?page=landing/berita/detail&id_berita=<?= $data3['id_berita'] ?>"><?= $data3['judul'] ?></a></div>
                            <?php
                            }
                            ?>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="images/<?= $data['gambar'] ?>" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href=""><?= $data['nama_kategori'] ?></a>
                                <a class="text-body" href=""><?= $data['tanggal'] ?></a>
                            </div>
                            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold"><?= $data['judul'] ?></h1>
                            <p><?= $data['isi'] ?></p>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            <div class="media mb-4">
                                <img src="landing/assets/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
