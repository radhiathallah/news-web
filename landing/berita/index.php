<?php
$query2 = mysqli_query($koneksi, "SELECT * FROM tb_kategori JOIN tb_berita ON tb_kategori.id_kategori=tb_berita.id_kategori ORDER BY id_berita DESC LIMIT 2");
                        ...
                        if (mysqli_num_rows($query2) > 0) {
                            while ($data2 = mysqli_fetch_array($query2)) { ?>
                                <div class="section-title">
                                    <h4 class="m-0 text-uppercase font-weight-bold">Kategori: <?= $data2['nama_kategori'] ?></h4>
                    ...
                    <div class="col-lg-6">
                        <div class="position-relative mb-3">
                            ...
                            <div class="bg-white border border-top-0 p-4">
                                ...
                                <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="?page=landing/berita/detail&id_berita=<?= $data2['id_berita'] ?>"><?= $data2['judul'] ?></a>
