...
$query1 = mysqli_query($koneksi, "SELECT COUNT(id_kategori) AS jumlah_kategori FROM tb_kategori");
$kategori = mysqli_fetch_array($query1);

$query2 = mysqli_query($koneksi, "SELECT COUNT(id_berita) AS jumlah_berita FROM tb_berita");
$berita = mysqli_fetch_array($query2);

$query3 = mysqli_query($koneksi, "SELECT COUNT(id_pengurus) AS jumlah_pengurus FROM tb_pengurus");
$pengurus = mysqli_fetch_array($query3);

$query4 = mysqli_query($koneksi, "SELECT COUNT(id_user) AS jumlah_user FROM tb_user");
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="stat-widget-two card-body">
                        ...
                        <div class="progress">
                            <div class="progress-bar progress-bar-success w-<?= $kategori['jumlah_kategori'] ?>" role="progressbar" aria-valuenow="<?= $kategori['jumlah_kategori'] ?>" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="stat-widget-two card-body">
                        <div class="stat-content">
                            ...
                            <div class="stat-digit"><i class="fa fa-newspaper"></i><?= $berita['jumlah_berita'] ?></div>
                        </div>
                        <div class="progress">
                            <div class="progress-bar progress-bar-primary w-<?= $berita['jumlah_berita'] ?>" role="progressbar" aria-valuenow="<?= $berita['jumlah_berita'] ?>" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="card">
                    <div class="stat-widget-two card-body">
                        <div class="stat-content">
                            <div class="stat-text">Berita</div>
                            <div class="stat-digit"><i class="fa fa-newspaper"></i><?= $pengurus['jumlah_pengurus'] ?></div>
                        </div>
                        <div class="progress">
                            <div class="progress-bar progress-bar-secondary w-<?= $pengurus['jumlah_pengurus'] ?>" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="5"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="stat-widget-two card-body">
                        <div class="stat-content">
                            ...
                            <div class="stat-digit"><i class="fa fa-newspaper"></i><?= $user['jumlah_user'] ?></div>
                        </div>
                        <div class="progress">
                            <div class="progress-bar progress-bar-danger w-<?= $user['jumlah_user'] ?>" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="5"></div>
                        </div>
                    </div>
                </div>
            </div>
